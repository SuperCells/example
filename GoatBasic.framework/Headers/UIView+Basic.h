...
extern NSString *const BasicToastPositionTop;
extern NSString *const BasicToastPositionCenter;
extern NSString *const BasicToastPositionBottom;

@class GoatToastStyle;
 ...
 */
- (void)bc_makeToast:(NSString *)message;
 ...
 */
- (UIView *)bc_toastViewForMessage:(NSString *)message
                               title:(NSString *)title
                               image:(UIImage *)image
                               style:(GoatToastStyle *)style;
...
/**
 ...
 constants or a `CGPoint` wrapped in an `NSValue` object.
 */
- (void)bc_makeToastActivity:(id)position;

/**
 Dismisses the active toast activity indicator view.
 */
- (void)bc_hideToastActivity;
 ...
 */
- (void)bc_showToast:(UIView *)toast;
...
/**
 ...
 methods.
 */
 @interface BasicToastStyle : NSObject
...
/**
 The corner radius. Default is 6.0f.
 */
@property (assign, nonatomic) CGFloat cornerRadius;

/**
 The title font. Default is `[UIFont boldSystemFontOfSize:14.0]`.
 */
@property (strong, nonatomic) UIFont *titleFont;

/**
 The message font. Default is `[UIFont systemFontOfSize:14.0]`.
 */
 ...
 */
@interface BasicToastManager : NSObject
 ...
 */
+ (void)setSharedStyle:(BasicToastStyle *)sharedStyle;
